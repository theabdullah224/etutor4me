...
const StudentsFaqs:React.FC = () => {
    const studentsFaqs:FAQItem[] = [
        ...
        { question: 'What if I’m not satisfied with my eTutor?', answer: 'If you are not satisfied with your eTutor, you can request a replacement or a refund within the first 15 minutes of the session.' },
      ];
