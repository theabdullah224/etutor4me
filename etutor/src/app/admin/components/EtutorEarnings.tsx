...
function EtutorEarnings() {
  ...
  return (
    <div className="px-3 custom-xl:px-6 py-3 custom-xl:py-6  bg-[#ede8fa] col-span-1 row-span-1 rounded-md sm:rounded-xl  custom-lg:rounded-3xl">
      ...
      <div className="flex justify-between h-full ">
        <div className="flex flex-col justify-between  h-full px-3 py-1.5">
          ...
          <h1 className="text-3xl md:text-4xl custom-lg:text-[65px]  mb-2 leading-none text-[#b293fc] font-medium py-2 custom-lg:py-6">
            $45289.54
          </h1>
        ...
        <div className=" flex flex-col justify-between   pt-3">
          <div className="flex items-center  flex-row-reverse text-[#7669b5]">
            <div className=" flex items-center justify-center gap-1 sm:gap-2 custom-lg:gap-3">
              ...
              <span className="font-bold text-base sm:text-lg custom-lg:text-2xl  w-fit  text-center">
                {currentName}
              </span>
