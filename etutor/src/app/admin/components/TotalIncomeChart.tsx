          ...
          {currentName === "Daily" && (
            <div className="flex items-center  flex-row-reverse text-[#7669b5]">
              <div className=" flex items-center justify-center gap-3">
                ...
                <span className="font-medium text-xl  w-[11.4rem] text-center  ">
                  {" "}
          ...
          {currentName === "Weekly" && (
            <div className="flex items-center  flex-row-reverse text-[#7669b5]">
              <div className=" flex items-center justify-center gap-3">
                ...
                <span className="font-medium text-lg  w-[14.4rem] text-center  ">
                  {" "}
          ...
          {currentName === "Monthly" && (
            <div className="flex items-center  flex-row-reverse text-[#7669b5]">
              <div className=" flex items-center justify-center gap-3">
                ...
                <span className="font-bold text-xl  w-[6.3rem] text-center  ">
                  {" "}
